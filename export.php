...
?>
    ...
    <div class="ui raised segment" style="height:90%;width:90%;overflow:auto;margin:0 auto;margin-bottom:3%;padding:2%;">
...
?> 
<script>
    $("#Dates").append("<th>No.of.Days<br></br>Present</th><th>No.of.Days<br></br>Absent</th><th>Total Working Days</th><th>Attendance <br></br>Percentage</th>");
    var P,A,T,per;
